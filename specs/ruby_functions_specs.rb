...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    volume_result = volume_of_cube(4, 4, 4)
  ...
  def test_volume_of_sphere()
    sp_volume_result = volume_of_sphere(4/3, 3.141592,5.0)
    assert_equal( 392.699, sp_volume_result )
  end
  #
  # #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    temp_result = fahrenheit_to_celsius(77)
    assert_equal(25.0, temp_result)
  end
  #
